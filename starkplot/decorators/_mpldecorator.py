...
from .._util import (
    ...
    _parseoptsdict, _parselatexstrandopts, _parsestrandopts,
...
""".format(_descrargs=_descrargs, xkwargs=xkwargs)
...
class MatplotlibDecorator(object):
    ...
    def __new__(cls, func=None, funcdoc=None,
        ...
        class decorator(MatplotlibDecoratorBase):
            ...
            # __init__
            def __init__(self, funcdoc=funcdoc,
                         # figure
                         fig=fig, rtcf=rtcf,
                         figsize=figsize, overridefig=overridefig,
            ...
            def __call__(self, wrapped_function):
                ...
                def wrapped(*func_args,
                    ...
                    fig, oldfig = _prepare_figure(fig=fig, rtcf=rtcf,
                                                  figsize=figsize, **wkw)
                    ...
                    if sidehists:
                        ...
                        pyplot.setp((axHistx.get_xticklabels() +
